...
public class Context {
    ...
    public static User fakeuser = new User(0, "fake",0);
    ...
    public static void updateCurrentUser() {
        ...
        try {
            ...
            while (queryResult.next()) {
                currentUser = new User(queryResult.getInt("id"), queryResult.getString("Benutzername"), queryResult.getInt("bedienernummer"));
            }
